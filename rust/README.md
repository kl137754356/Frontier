# 🦞 Frontier — Rust Implementation

A high-performance Rust rewrite of the Frontier CLI agent harness. Built for speed, safety, and native tool execution.
